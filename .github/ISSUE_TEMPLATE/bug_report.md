...
## Log File
<!-- Provide log files for better debugging (Located in the logs folder). Use a service like [Pastebin](https://pastebin.com/) or [Github Gists](https://gist.github.com/) to share logs. Put the urls into rounded brackets -->
- Animus Reforged Log: [Pastebin link]()
